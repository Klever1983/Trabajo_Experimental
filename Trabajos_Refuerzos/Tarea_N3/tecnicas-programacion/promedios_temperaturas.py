...
# Dimensiones:
#  - Primera: ciudades (3 ciudades)
#  - Segunda: semanas (4 semanas)
#  - Tercera: días (7 días por semana, cada uno con un diccionario 'day' y 'temp')
...
# FUNCIÓN PARA CALCULAR PROMEDIOS POR SEMANA Y CIUDAD
def calcular_promedios(temperaturas):
    """
    Calcula y muestra el promedio de temperaturas por ciudad y por semana.
